...
--
GRANT SELECT, RELOAD, SHOW DATABASES, REPLICATION SLAVE, REPLICATION CLIENT, LOCK TABLES  ON *.* TO 'windwheel'@'%';
CREATE USER 'windwheel' IDENTIFIED BY 'knxy0616';
-- GRANT ALL PRIVILEGES ON *.* TO 'windwheel'@'%';
